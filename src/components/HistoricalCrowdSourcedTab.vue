  ...
  <div>
    <sui-container>
      <p v-if="bioResults.length > 0">
        ...
        <sui-button circular icon="exclamation"  @click.native="disclaimerToggle"/>
        <sui-modal v-model="disclaimerOpen">
      <sui-modal-header>Crowd-Sourced Information Disclaimer</sui-modal-header>
      <sui-modal-content>
          <p>
        The following information was developed and maintained by volunteers.
        The information includes data from secondary sources, which are not guaranteed to be checked for accuracy and do not necessarily reflect the opinions of any organization or group. 
        No organization, group, or volunteer endorses or accepts responsibility over any external sites that may be linked in this information. 
        The volunteers who contributed to this information make absolutely no guarantees as to the currency, accuracy, completeness, or quality of information written and/or archived on the website, and no organization, group, or volunteer assumes any liability for the currency, accuracy, completeness, or quality of information written and/or archived on the website. 
        The inclusion of names, links and other references is purely on the basis of their relevance to the information.
          </p>
      </sui-modal-content>
      <sui-modal-actions>
